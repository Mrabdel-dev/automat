...
pdsFile = ''
pds = load_workbook('PDS/SRO-21_011_067_PLAN_BOITES.xlsx')
wpds = pds.sheetnames
...
dblTable = DBF('pdsInput/zpbodbl067.dbf', load=True, encoding='iso-8859-1')
...
epesBook = xlsxwriter.Workbook('epesExcel/21_011_067_EPISSURES.xlsx')
