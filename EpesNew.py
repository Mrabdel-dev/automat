...
pdsFile = ''
pds = load_workbook('PDS/85_072_794_PLAN_BOITES-EXEL.xlsx')
wpds = pds.sheetnames
...
dblTable = DBF('pdsInput/zapbodbl794.dbf', load=True, encoding='iso-8859-1')
...
epesBook = xlsxwriter.Workbook('epesExcel/SRO-85_072_794_EPISSURES.xlsx')
