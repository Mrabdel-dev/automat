...
pdsFile = ''
pds = load_workbook('PDS/SRO-85_048_567-PLAN_DE_BOITE.xlsx')
wpds = pds.sheetnames
...
dblTable = DBF('pdsInput/zpbodbl567.dbf', load=True, encoding='iso-8859-1')
...
epesBook = xlsxwriter.Workbook('epesExcel/SRO-85_048_567_EPISSURES_C.xlsx')
