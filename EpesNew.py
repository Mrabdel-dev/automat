...
pdsFile = ''
pds = load_workbook('PDS/21-011-068-PLAN DE BOITE.xlsx')
wpds = pds.sheetnames
...
dblTable = DBF('pdsInput/ZAPDBL_068.dbf', load=True, encoding='iso-8859-1')
...
epesBook = xlsxwriter.Workbook('epesExcel/SRO-21_011_068_EPISSURES_C.xlsx')
