...
pdsFile = ''
pds = load_workbook('PDS/SRO-85_018_258_PLAN_BOITES.xlsx')
wpds = pds.sheetnames
...
dblTable = DBF('pdsInput/zpbodbl258.dbf', load=True, encoding='iso-8859-1')
...
epesBook = xlsxwriter.Workbook('epesExcel/85_018_258_EPISSURES.xlsx')
