...
pdsFile = ''
pds = load_workbook('PDS/31-206-327-PLAN_DE_BOITE.xlsx')
wpds = pds.sheetnames
...
dblTable = DBF('pdsInput/ZAPBO-DBL 327.dbf', load=True, encoding='iso-8859-1')
...
epesBook = xlsxwriter.Workbook('epesExcel/SRO-31-206-327_EPISSURES_C.xlsx')
