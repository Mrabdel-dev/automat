...
pdsFile = ''
pds = load_workbook('PDS/SRO-85_018_261-Pds.xlsx')
wpds = pds.sheetnames
...
dblTable = DBF('pdsInput/zpbodbl261.dbf', load=True, encoding='iso-8859-1')
...
epesBook = xlsxwriter.Workbook('epesExcel/SRO-85_018_261_EPISSURES_C.xlsx')
