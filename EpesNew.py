...
boiteTable = DBF('pdsInput/85_018_261_BOITE_OPTIQUE_C.dbf', load=True, encoding='iso-8859-1')
...
epesBook = xlsxwriter.Workbook('epesExcel/SRO-85_018_261_EPISSURES.xlsx')
