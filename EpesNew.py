...
pdsFile = ''
pds = load_workbook('PDS/SRO-85_048_571_PLAN_BOITES-A.xlsx')
wpds = pds.sheetnames
...
dblTable = DBF('pdsInput/zpbodbl571.dbf', load=True, encoding='iso-8859-1')
...
epesBook = xlsxwriter.Workbook('epesExcel/85_048_571_EPISSURES.xlsx')
