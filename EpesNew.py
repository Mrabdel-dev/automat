...
pdsFile = ''
pds = load_workbook('PDS/SRO-21_011_069-PLAN_DE_BOITE.xlsx')
wpds = pds.sheetnames
...
dblTable = DBF('pdsInput/zpbodbl069.dbf', load=True, encoding='iso-8859-1')
...
epesBook = xlsxwriter.Workbook('epesExcel/SRO-21_011_069_EPISSURES_C.xlsx')
