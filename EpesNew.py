...
pdsFile = ''
pds = load_workbook('PDS/31_206_293_PLAN_BOITES.xlsx')
wpds = pds.sheetnames
...
dblTable = DBF('pdsInput/zpbodbl293.dbf', load=True, encoding='iso-8859-1')
...
epesBook = xlsxwriter.Workbook('epesExcel/31_206_293_EPISSURES.xlsx')
