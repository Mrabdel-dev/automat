...
rowmax = 0
# ##########################################################################################
with open('epesourageCSV/SRO-21_011_068_EPISSURES_C.csv', 'rt')as f:
...
# sroCable = sroCab
sroCable = ['CDI-21-011-068-1045', 'CDI-21-011-068-2045']
print(dictCable)
print(sortedSro)
print(sroCab)
print(sroCable)
# ########################################################################################
# <-----------------------route file creation------------------------------------------->
rootBook = xlsxwriter.Workbook('routage/Rootage-SRO-21_011_068.xlsx')
