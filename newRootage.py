...
rowmax = 0
# ##########################################################################################
with open('epesourageCSV/21_017_104_EPISSURES_C (1).csv', 'rt')as f:
...
# sroCable = sroCab
sroCable = ['CDI-21-017-104-3014', 'CDI-21-017-104-1001', 'CDI-21-017-104-2000']
print(dictCable)
print(sortedSro)
print(sroCab)
print(sroCable)
# ########################################################################################
# <-----------------------route file creation------------------------------------------->
rootBook = xlsxwriter.Workbook('routage/Rootage-SRO-21_017_104-_.xlsx')
