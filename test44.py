...
def getLastStartBoite(boite):
    ...
    #     if func == "PEC":
    #         boits = getListComingBoite(orginBoite)
    #         if len(boits) < 2 and capacity == capacity2:
    #             return boite
    #
    #     elif func == "PBO":
    #
...
for b in range(0, boiteLen):
    ...
    #     break
    boite = boiteCode[b]
    # if str(boite)[-4] == "1" or str(boite)[-4] == "2" or str(boite)[-4] == "3"or str(boite)[-4:] == "4004" or str(boite)[-4:] == "4003" or str(boite)[-4:] == "4002":
    #     continue
...
#     except:
#         print(i)
# boite = 'PBO-31-206-328-4004'
# # # cable = "CDI-21-011-074-2007"
# # # capacity = getCapacity(cable)
# b = getLastStartBoite(boite)
# listff = []
# c = getAllboitestart(b,boite,listff)
# print(b,c)
# linestockstart = getStockStartLine(boite) + 1
# print(linestockstart)
# index = boiteCode.index(boite)
# ftte = checkGlobalFtt(boite)
# ftt = checkFtt(boite)
# fttepass = getPassedFtte(boite, capacity)
