...
Image.place(x=200, y=370)
heading = Label(text="PDS GENERATOR", bg="#D4E1DB", fg="black", width="500", height="3")
cableT = Label(text="cableTable : ", bg="#E8F6FF")
boiteT = Label(text="boiteTable : ", bg="#E8F6FF")
ZPBoDBL_JOINTURE = Label(text="ZPBoDBL_JOIN : ", bg="#E8F6FF")
casseteT = Label(text="CasseteTable : ", bg="#E8F6FF")
PDS_directory = Label(text="PDS_directory : ", bg="#E8F6FF")
SRO_Name = Label(text="SRO_Name : ", bg="#E8F6FF")
...
PDS_directory.place(x=0, y=280)
SRO_Name.place(x=300, y=309)
...
directory = StringVar()
pdsName = StringVar()
firstName_entry = Entry(textvariable=cableT,bg="#92FACD", width="60")
lastName_entry = Entry(textvariable=boiteT,bg="#92FACD", width="60")
age_entry = Entry(textvariable=ZPBoDBL_JOINTURE,bg="#92FACD", width="60")
cassete_entry = Entry(textvariable=casseteT,bg="#92FACD", width="60")
directory_pds = Entry(textvariable=directory,bg="#92FACD", width="60",master=screen)
PdsName = Entry(textvariable=pdsName,bg="#92FACD", width="30")
...
directory_pds.place(x=110, y=280)
PdsName.place(x=380, y=309)
Browser1 = Button(screen, text="Browser", command=partial(openFile, 1))
Browser1.place(x=500, y=70)
...
Browser5 = Button(screen, text="Browser", command=opendir)
Browser5.place(x=500, y=280)
my_progress = ttk.Progressbar(screen, orient=HORIZONTAL, length=400, mode='determinate')
my_progress.pack(pady=20)
my_progress.place(x=110, y=335)
start = Button(screen, text="start", bg="#65F2ED", fg="black", width=10, command=start)
start.place(x=20, y=335)
close = Button(screen, text="close", bg="#D4E1DB", fg="black", width=10, command=screen.destroy)
